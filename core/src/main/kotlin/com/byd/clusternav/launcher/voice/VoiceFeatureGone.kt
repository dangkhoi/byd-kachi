...
internal object VoiceFeatureGone {
     ...
     *
     * ⚠ `light_left_turn` / `light_right_turn` / `emergency_alarm` / `mirror_fold` / `op_mode` vẫn là datum ĐỌC
     * có thật — đó là lý do [removed] của bốn dòng đầu nói về **nút**, không nói về thông tin.
     */
