...
object TelemetryRegistry {
    ...
    private fun t(
        ...
        tier: EvidenceTier,
        key: String,
    ) = TelemetrySpec(id, label, unit, domain, shape, tier, key)
    ...
    val ALL: List<TelemetrySpec> = listOf(
        ...
        t("ev_range_km", "Tầm hoạt động EV", "km", ENERGY, VALUE, OVERDRIVE, "BYDAutoStatisticDevice.getElecDrivingRangeValue"),
        t("fuel_range_km", "Tầm hoạt động xăng", "km", ENERGY, VALUE, OVERDRIVE, "1246773304"),
        ...
        t("trip_km", "Quãng đường chuyến", "km", ENERGY, VALUE, OVERDRIVE, "1246801948"),
        t("trip_hours", "Thời gian chuyến", "h", ENERGY, VALUE, OVERDRIVE, "1246801938"),
        t("trip_kwh", "Điện tiêu thụ chuyến", "kWh", ENERGY, VALUE, OVERDRIVE, "1246801976"),
        ...
        t("soh_oem", "Sức khoẻ pin (SOH)", "%", ENERGY, CARD, OVERDRIVE, "1145045032"),
        ...
        t("motor_front_rpm", "Vòng tua mô-tơ trước", "rpm", DRIVETRAIN, VALUE, OVERDRIVE, "1141899272"),
        t("motor_rear_rpm", "Vòng tua mô-tơ sau", "rpm", DRIVETRAIN, VALUE, OVERDRIVE, "621805576"),
        t("motor_front_torque", "Mô-men mô-tơ trước", "Nm", DRIVETRAIN, VALUE, OVERDRIVE, "1141899288"),
        ...
        t("inside_temp", "Nhiệt cài đặt", "°C", CLIMATE, VALUE, OVERDRIVE, "BYDAutoAcDevice.getTemprature"),
        ...
        // ── A4. Lốp (TPMS) ──────────────────────────────────────────────────────────────────────
        t("tyre_p_fl", "Áp lốp trước-trái", "kPa", TYRES, BOARD, PROVEN, "BYDAutoTyreDevice.getTyrePressureLeftFront"),
        t("tyre_p_fr", "Áp lốp trước-phải", "kPa", TYRES, BOARD, PROVEN, "BYDAutoTyreDevice.getTyrePressureRightFront"),
        t("tyre_p_rl", "Áp lốp sau-trái", "kPa", TYRES, BOARD, PROVEN, "BYDAutoTyreDevice.getTyrePressureLeftRear"),
        t("tyre_p_rr", "Áp lốp sau-phải", "kPa", TYRES, BOARD, PROVEN, "BYDAutoTyreDevice.getTyrePressureRightRear"),
        t("tyre_t_fl", "Nhiệt lốp trước-trái", "°C", TYRES, BOARD, NEEDS_CAR, "1246797848"),
        t("tyre_t_fr", "Nhiệt lốp trước-phải", "°C", TYRES, BOARD, NEEDS_CAR, "1246797860"),
        t("tyre_t_rl", "Nhiệt lốp sau-trái", "°C", TYRES, BOARD, NEEDS_CAR, "1246797872"),
        t("tyre_t_rr", "Nhiệt lốp sau-phải", "°C", TYRES, BOARD, NEEDS_CAR, "1246797884"),
        ...
        t("dow_left", "Mở cửa cảnh báo trái", "", SAFETY, STRIP, OVERDRIVE, "1098907680"),
        t("dow_right", "Mở cửa cảnh báo phải", "", SAFETY, STRIP, OVERDRIVE, "1098907682"),
        t("radar_zones", "Cảm biến đỗ (8 vùng)", "", SAFETY, BOARD, OVERDRIVE, "BYDAutoRadarDevice.getAllRadarProbeStates"),
        t("radar_volume", "Âm lượng cảm biến", "", SAFETY, VALUE, OVERDRIVE, "BYDAutoRadarDevice.getRadarVolume"),
        t("esp_state", "Cân bằng điện tử (ESP)", "", SAFETY, BADGE, OVERDRIVE, "305135676"),
        t("mcu_status", "Trạng thái nguồn (MCU)", "", SAFETY, BADGE, OVERDRIVE, "BYDAutoPowerDevice.getMcuStatus"),
