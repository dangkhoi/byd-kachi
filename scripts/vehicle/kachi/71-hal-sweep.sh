...
DENYLIST="lock door trunk sunroof sunshade windows_all windows_close_all win_lf win_rf win_lr win_rr win_half_all win_half_lf win_half_rf win_half_lr win_half_rr"
