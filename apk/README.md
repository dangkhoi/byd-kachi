...
> **Trạng thái**: Current · **Cập nhật**: 2026-09-18 (Kachi-1.83-release.apk vc84 sha256 df7b832f…) · **Mục đích**: Thư mục APK phát hành để app **tự cập nhật qua mạng (OTA)** xuống xe — cùng cơ chế ClusterNav 2.0 đã dùng.
