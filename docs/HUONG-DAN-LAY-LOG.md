...
> **Trạng thái**: Historical (đời ClusterNav 1.x; thay bằng `HUONG-DAN-KACHI.md` 2026-09-25) · **Cập nhật**: 2026-08-17 · **Mục đích**: Cách lấy log + ảnh sau khi lái thử (Cách A không cần máy tính / Cách B dùng máy tính).
