...
> **Trạng thái**: **Archived 2026-09-25** (vi phạm R0 — backlog song song; mọi mục còn mở đã gộp vào `docs/PROJECT-BACKLOG.md` §Nhóm CLOSE với ID `CB-*` giữ số gốc; KHÔNG cập nhật file này nữa) · **Tạo**: 2026-09-22 · **Mục đích (gốc)**: gom MỌI việc còn lại để đóng dự án, sau khi phiên off-car 1.90 (91) đã ship 16 việc owner.
> Nguồn: chắt từ `docs/PROJECT-BACKLOG.md`.
