...
> **Loại**: Diagnostics (on-car playbook) · **Trạng thái**: Superseded — thay bởi `oncar-playbook-kachi-1.53.md`; phần “Vosk” đã lỗi thời (tầng nghe nay là sherpa-onnx, xem `docs/specs/kachi-voice-engine-v2.html`) · **Cập nhật**: 2026-09-14 · **Chủ**: dangkhoi
