...
| [`specs/kachi-capability-icons.html`](specs/kachi-capability-icons.html) | **U1 — Icon theo khái niệm + nhãn phân biệt được**: [ĐO] 123 mục đọc chỉ dùng **7 icon** (icon lấy theo NHÓM) và 59 tệp icon nhưng chỉ 29 được nối ⇒ bảng chọn có hàng 5 ô trông y hệt. Bảng tra theo khái niệm ở `:core` (khớp mã → tiền tố → lùi về nhóm, KHÔNG sửa 123 dòng registry) + 6 icon vẽ mới. **[ĐO] 7 → 29 icon phân biệt**. Kèm lỗi phát sinh từ gói 2: **18 nhãn trùng** giữa đọc↔hành động + 1 ca trùng cùng loại ⇒ thêm gợi ý loại CHỈ ở chỗ trùng (0 trùng còn lại) | DONE off-car | 2026-09-11 |
