...
| Doc | Mục đích | Trạng thái | Cập nhật |
|-----|----------|-----------|----------|
| [`specs/kachi-remove-legacy-screen.html`](specs/kachi-remove-legacy-screen.html) | **S3 — Gỡ hẳn màn ClusterNav cũ, giữ đủ tính năng** (owner 2026-09-13): chuyển 4 thứ còn thiếu (khung/DPI khi chiếu · preview cụm · disclaimer · op39) rồi xoá MainActivity + 7 lớp + ~12 test đọc source; 2 tệp seal T11 để nguyên trên đĩa | In-progress | 2026-09-13 |
| [`specs/kachi-icon-set-v2.html`](specs/kachi-icon-set-v2.html) | **U7 — Bộ icon v2 hình xe theo vị trí** (owner: "fancy, vẽ visual như hình xe, dễ hiểu dễ chọn"): 3 khung xe (top/front/rear) + vùng tô cho cửa/kính/lốp/ghế/đèn/ADAS; huy hiệu "chưa kiểm" đảo dấu | In-progress | 2026-09-13 |
