...
| [`diagnostics/kachi-emulator-app-hosting-2026-09-10.md`](diagnostics/kachi-emulator-app-hosting-2026-09-10.md) | **Kachi trên emulator — Play Store, dadb loopback & host app vào ô**: gốc popup adb lặp (Play image khoá cứng) · recipe loopback đúng (google_apis, 1 emulator) · **bug host-app-lúc-mở + diff sửa** (P-bug2, đã revert) · **giới hạn app từ chối display phụ** (D-emu, verify trên xe) · GMS cũ · icon/badge | Current | 2026-09-10 |
