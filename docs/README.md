...
> **Trạng thái**: Current · **Cập nhật**: 2026-09-13 · **Mục đích**: Bản đồ MỌI tài liệu hiện hành theo 9-loại taxonomy (R4). Không có trong index = archive/stale, KHÔNG authoritative (R0).
...
| [`diagnostics/oncar-playbook-kachi-1.47.md`](diagnostics/oncar-playbook-kachi-1.47.md) | **PLAYBOOK LÊN XE — Kachi 1.47**: chuẩn bị ở nhà (release KHÔNG debuggable ⇒ không `run-as`; build `vehicleTest` cùng khoá khi cần prefs) · kết nối + baseline · **13 mục test xếp theo rủi ro tăng dần** (S2 · W1/L-RE2 · U7/U9 màu trạng thái thật · U8a/U10/U11 · L2 OTA · U12 · U13/S4 hồ sơ + V-mig + P7 · W5 đo phím · W2 · S3 khung/DPI · X1 chiếu-cụm · D-emu), mỗi mục có mục tiêu/bước/kỳ vọng/pass-fail/**hoàn tác** · thông tin bắt buộc mang về · cây quyết định · 14 bẫy. Bộ script: `scripts/vehicle/kachi/` (`run-all.sh` + 8 bước, output vào `docs/diagnostics/carlog-kachi-*/`) | Current | 2026-09-14 |
