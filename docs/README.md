...
| [`specs/kachi-icon-set-v2.html`](specs/kachi-icon-set-v2.html) | **U7 — Bộ icon v2 hình xe theo vị trí** (owner: "fancy, vẽ visual như hình xe, dễ hiểu dễ chọn"): 3 khung xe (top/front/rear) + vùng tô cho cửa/kính/lốp/ghế/đèn/ADAS; huy hiệu "chưa kiểm" đảo dấu. **DONE off-car 2026-09-13**: 168 icon, hình phân biệt 65 → 117, trần ≤3 cả 8 nhóm | Current | 2026-09-13 |
